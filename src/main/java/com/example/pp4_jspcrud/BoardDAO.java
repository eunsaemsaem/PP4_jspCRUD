...
public class BoardDAO {
	...
	private final String BOARD_UPDATE = "update BOARD set title=?, writer=?, content=?, category=?, regdate=? where seq=?";
...
//			stmt.setString(4, vo.getFileimg());
	...
	public int updateBoard(BoardVO vo) {
		...
		try {
			...
			stmt.setString(3, vo.getContent());
			stmt.setString(4, vo.getCategory());
			stmt.setDate(5, (java.sql.Date)vo.getRegdate());
